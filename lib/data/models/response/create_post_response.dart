...
class Op {
  ...
  factory Op.fromJson(Map<String, dynamic> json) => Op(
        ...
        distinctViews:
            json['distinctViews'] == null ? [] : List<dynamic>.from((json['distinctViews'] as List).map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        'createdOn': createdOn,
        'timeStamp': timeStamp,
        'distinctViews': distinctViews == null ? [] : List<dynamic>.from(distinctViews!.map((x) => x)),

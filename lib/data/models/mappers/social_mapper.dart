...
class SocialMapper {
  ...
  CustomResponse<List<ReportReason>?> mapReasonData(ResponseModel response) =>
      CustomResponse(
  ...
  CustomResponse<CommentsResponse?> mapCommentsResponse(
          ResponseModel response) =>
      CustomResponse(
          data: commentsResponseFromJson(response.data),
          responseCode: response.statusCode);

  CustomResponse<PostDetailsResponse?> mapPostDetailsResponse(
          ResponseModel response) =>
      CustomResponse(
          data: postDetailsResponseFromJson(response.data),
          responseCode: response.statusCode);
  ...
  CustomResponse<SearchUserResponse?> mapSearchUserResponse(
          ResponseModel response) =>
      CustomResponse(
          data: searchUserResponseFromJson(response.data),
          responseCode: response.statusCode);

  CustomResponse<HashTagResponse?> mapSearchTagResponse(
          ResponseModel response) =>
      CustomResponse(
          data: hashTagResponseFromJson(response.data),
          responseCode: response.statusCode);

  CustomResponse<SocialUserProfileResponse?> mapUserProfileResponse(
          ResponseModel response) =>
      CustomResponse(
  ...
  CustomResponse<TimeLineData?> mapTimelineData(ResponseModel response) {
    final timeLineData = TimeLineData.fromMap((jsonDecode(response.data)
  ...
  CustomResponse<InsightsTimeSeriesResponse?> mapPostInsightTimeSeriesResponse(
          ResponseModel response) =>
      CustomResponse(
          data: insightsTimeSeriesResponseFromJson(response.data),
          responseCode: response.statusCode);

...
class CommentMentionData {
  ...
  factory CommentMentionData.fromJson(Map<String, dynamic> json) =>
      CommentMentionData(
        ...
        textPosition: json['text_position'] == null
            ? null
            : CommentTaggedPosition.fromJson(
...
class CommentTaggedPosition {
  ...
  factory CommentTaggedPosition.fromJson(Map<String, dynamic> json) =>
      CommentTaggedPosition(

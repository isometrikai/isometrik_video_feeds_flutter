...
class IsrVideoReelConfig {
  ...
  static Future<void> _saveUserInformation({
    ...
    await localStorageManager.saveValue(LocalStorageKeys.isLoggedIn, true, SavedValueDataType.bool);
  }
  ...
  static void logEvent(String eventName, Map<String, dynamic> eventData) async {
    EventQueueProvider.instance.logEvent(eventName, eventData.removeEmptyValues());
  }

  static List<BlocProvider> getIsmSingletonBlocProviders() => [
        BlocProvider(create: (_) => IsmInjectionUtils.getBloc<IsmSocialActionCubit>()),
      ];
}

...
class PostBloc extends Bloc<PostEvent, PostState> {
  PostBloc(
    ...
    on<FollowingPostsLoadedEvent>(_loadFollowingPosts);
  ...
  final List<PostDataModel> _followingPostList = [];
  final List<PostDataModel> _trendingPostList = [];
  ...
  FutureOr<void> _loadFollowingPosts(FollowingPostsLoadedEvent event, Emitter<PostState> emit) async {
    emit(FollowingPostsLoadedState(followingPosts: event.followingPosts));
  }

  FutureOr<void> _loadTrendingPosts(TrendingPostsLoadedEvent event, Emitter<PostState> emit) async {
    emit(TrendingPostsLoadedState(trendingPosts: event.trendingPosts));
  }

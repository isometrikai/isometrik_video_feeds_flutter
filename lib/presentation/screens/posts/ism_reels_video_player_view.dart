          ...
          (index) => Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: index < currentPage ? IsrColors.white : IsrColors.white.changeOpacity(0.2),
                            ...
                            child: ValueListenableBuilder<bool>(
                              ...
                              builder: (context, value, child) {
                                try {
                                  ...
                                  debugPrint('❌ Error building description widget: $e');
                                  debugPrint('   Post ID: ${_reelData.postId}');
                                  debugPrint('   Description length: ${_postDescription.length}');

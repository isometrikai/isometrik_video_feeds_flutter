...
class _PostListingViewState extends State<PostListingView> {
  ...
  Widget _buildTabNavigation() => Container(
    height:
        _searchScreenUIConfig?.tabNavigationConfig?.height ?? IsrDimens.fifty,
    decoration: BoxDecoration(
      color:
          _searchScreenUIConfig?.tabNavigationConfig?.backgroundColor ??
          IsrColors.white,
      border: Border(
        bottom: BorderSide(
          color:
              _searchScreenUIConfig?.tabNavigationConfig?.borderColor ??
              IsrColors.colorEFEFEF,
          width: _searchScreenUIConfig?.tabNavigationConfig?.borderWidth ?? 1,
        ),
      ),
    ),
    child: Row(
  ...
  PreferredSizeWidget _buildAppBar() => IsmCustomAppBarWidget(
    ...
    backgroundColor:
        _searchScreenUIConfig?.appBarConfig?.backgroundColor ?? IsrColors.white,
    titleWidget: _buildHashtagSearchBar(),
    showTitleWidget: true,
    showDivider: _searchScreenUIConfig?.appBarConfig?.showDivider ?? true,
    dividerColor:
        _searchScreenUIConfig?.appBarConfig?.dividerColor ??
        IsrColors.colorEFEFEF,
  );
                ...
                decoration:
                    ...
                    BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(
                        _searchScreenUIConfig?.searchBarConfig?.borderRadius ??
                            IsrDimens.twenty,
                      ),
                      border: Border.all(
                        color:
  ...
  Widget _buildBody() => BlocConsumer<PostListingBloc, PostListingState>(
    ...
    builder: (context, state) {
      ...
      if (state is PostListingLoadingState &&
        ...
        return Center(
          child:
              _searchScreenUIConfig?.loadingConfig?.indicator ??
              const AppLoader(),
        );
      }
  ...
  Widget _buildPostsGridWithoutController(List<TimeLineData> postList) =>
      CustomScrollView(
        ...
        slivers: [
          SliverPadding(
            padding:
                _searchScreenUIConfig?.postsGridConfig?.padding ??
  ...
  Widget _buildPlacesListWithoutController(
    ...
    itemBuilder: (context, index) {
      ...
      return Container(
        ...
        margin:
            _searchScreenUIConfig?.placesListConfig?.margin ??
            IsrDimens.edgeInsetsSymmetric(
              vertical: 4.responsiveDimension,
              horizontal: 8.responsiveDimension,
            ),
        child: TapHandler(
          ...
          child: Padding(
            padding:
                _searchScreenUIConfig?.placesListConfig?.padding ??
                IsrDimens.edgeInsetsSymmetric(
            ...
            child: Row(
              ...
              children: [
                Padding(
                  ...
                  child: _searchScreenUIConfig?.placesListConfig?.icon != null
                      ? AppImage.svg(
                          _searchScreenUIConfig!.placesListConfig!.icon!,
                          width:
                              _searchScreenUIConfig?.placesListConfig?.iconSize,
                          height:
                              _searchScreenUIConfig?.placesListConfig?.iconSize,
  ...
  Widget _buildAccountsListWithoutController(
    ...
    itemBuilder: (context, index) {
      ...
      return Container(
        ...
        height:
            _searchScreenUIConfig?.accountsListConfig?.itemHeight ??
            80.responsiveDimension,
        margin:
            _searchScreenUIConfig?.accountsListConfig?.margin ??
            IsrDimens.edgeInsetsSymmetric(
              vertical: 4.responsiveDimension,
              horizontal: 8.responsiveDimension,
            ),
        child: TapHandler(
          ...
          child: Padding(
            padding:
                _searchScreenUIConfig?.accountsListConfig?.padding ??
                IsrDimens.edgeInsetsSymmetric(
                  horizontal: 16.responsiveDimension,
                  vertical: 12.responsiveDimension,
                ),
            child: Row(
              children: [
                Container(
                  width:
                      _searchScreenUIConfig?.accountsListConfig?.avatarSize ??
            ...
            children: [
              _searchScreenUIConfig?.emptyStateConfig?.icon != null
                  ? AppImage.svg(
                      ...
                      width:
                          _searchScreenUIConfig?.emptyStateConfig?.iconSize ??
                          IsrDimens.eighty,
                      height:
                          _searchScreenUIConfig?.emptyStateConfig?.iconSize ??
                          IsrDimens.eighty,
                      color:
                          _searchScreenUIConfig?.emptyStateConfig?.iconColor ??
                          IsrColors.color9B9B9B,
                    )
                  : AppImage.svg(
              ...
              SizedBox(
                height:
                    _searchScreenUIConfig?.emptyStateConfig?.spacing ??
  ...
  Widget _buildPostCard(TimeLineData post, int index) => Container(
    decoration:
        _searchScreenUIConfig?.postCardConfig?.decoration ??
        BoxDecoration(
          color:
              _searchScreenUIConfig?.postCardConfig?.backgroundColor ??
              IsrColors.white,
          borderRadius: BorderRadius.circular(
  ...
  Widget _buildShopButtonOverlay(TimeLineData post) => Positioned(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: IsrColors.white.applyOpacity(0.2), width: 1),
        boxShadow: [
          BoxShadow(
  ...
  Widget _buildVideoIcon() => Positioned(
    ...
    child: Center(
      child: Container(
        padding:
            _searchScreenUIConfig?.postCardConfig?.videoIconConfig?.padding ??
            IsrDimens.edgeInsetsAll(IsrDimens.eight),
        decoration:
            _searchScreenUIConfig
                ?.postCardConfig

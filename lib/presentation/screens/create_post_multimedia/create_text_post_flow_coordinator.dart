...
import 'package:ism_video_reel_player/presentation/bloc/create_post/create_post_bloc.dart';
...
/// Coordinates the text post creation flow (plain text + location + mentions).
abstract final class CreateTextPostFlowCoordinator {
  ...
  static Future<dynamic> runEdit(
    ...
    final page = BlocProvider<CreatePostBloc>.value(
      value: IsmInjectionUtils.getBloc<CreatePostBloc>(),
      child: CreateTextPostView(postData: postData),
    );

...
class AppLog {
  ...
  AppLog(this.message, [this.stackTrace]) {
    log(
      '\x1B[37m[${IsrAppConstants.appName}] - $message\x1B[0m',
  ...
  AppLog.error(this.message, [this.stackTrace]) {
    log(
      '\x1B[31m[${IsrAppConstants.appName}] - $message\x1B[0m',
      stackTrace: stackTrace,
      name: 'Error',
      level: 1200,
    );
  ...
  AppLog.success(this.message, [this.stackTrace]) {
    log(
      '\x1B[32m[${IsrAppConstants.appName}] - $message\x1B[0m',
      stackTrace: stackTrace,
      name: 'Success',
      level: 500,
    );
  ...
  AppLog.info(this.message, [this.stackTrace]) {
    log(
      '\x1B[33m[${IsrAppConstants.appName}] - $message\x1B[0m',
      stackTrace: stackTrace,
      name: 'Info',
      level: 800,
    );
  ...
  AppLog.highlight(this.message, [this.stackTrace]) {
    log(
      '\x1B[36m[${IsrAppConstants.appName}] - $message\x1B[0m',
      stackTrace: stackTrace,
      name: 'Highlight',
      level: 400,
    );

...
class AppModuleInjection {
  static void inject() {
    ...
    InjectionUtils.registerOtherClass<SharedPreferencesManager>(SharedPreferencesManager.new);
    InjectionUtils.registerOtherClass<LocalStorageManager>(
        () => LocalStorageManager(InjectionUtils.getOtherClass<SharedPreferencesManager>()));
    ...
    InjectionUtils.registerOtherClass<DataSource>(() => DataSourceImpl(
        InjectionUtils.getOtherClass<LocalStorageManager>(), InjectionUtils.getOtherClass<SessionManager>()));
    InjectionUtils.registerOtherClass<NavigationService>(() => NavigationServiceImpl(exNavigatorKey));

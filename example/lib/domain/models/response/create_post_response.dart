...
// import 'dart:convert';
//
// import 'package:flutter_ecommerce/domain/domain.dart';
//
...
class CreatePostResponse {
  ...
  factory CreatePostResponse.fromJson(Map<String, dynamic> json) => CreatePostResponse(
        ...
        data: json['data'] == null
            ? null
            : CreatePostData.fromJson(json['data'] as Map<String, dynamic>),
        message: json['message'] as String? ?? '',
...
class CreatePostData {
  CreatePostData({this.id});

  factory CreatePostData.fromJson(Map<String, dynamic> json) =>
      CreatePostData(id: json['id'] as String? ?? '');
  final String? id;

  CreatePostData copyWith({String? id}) => CreatePostData(id: id ?? this.id);
